...
return [
    ...
    "custom" => [
        "assignee_strategy" => ["duplicated_priorities" => "Podany priorytet został już przypisany."],
        "attribute-name" => ["rule-name" => ""],
        "business_registry_number" => "Podany numer REGON jest nieprawidłowy.",
        "clients" => ["fetch_data_needed" => "NIP lub REGON jest wymagany."],
        "comment" => ["invalid_parent" => "Niedozwolony komentarz nadrzędny."],
        "login_error" => "Podane dane są nieprawidłowe.",
        "media" => ["file_not_supported" => "Dany plik nie może być zapisany."],
        "taxpayer_number" => "Podany numer NIP jest nieprawidłowy.",
        "unique" => ":value już istnieje"
    ],
    ...
    "password" => [
        ...
        "mixed" => ":attribute musi zawierać co najmniej jedną małą i jedną dużą literę.",
        "numbers" => ":attribute musi zawierać co najmniej jedną liczbę.",
        "symbols" => ":attribute musi zawierać co najmniej jeden znak specjalny.",
        "uncompromised" => "Podane :attribute pojawiło się w wycieku danych. Prosimy wybrać inne :attribute."
    ],
